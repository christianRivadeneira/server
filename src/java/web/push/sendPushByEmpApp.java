...
@WebServlet(name = "sendPushEmpApp", urlPatterns = {"/sendPushEmpApp"})
public class sendPushByEmpApp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int appId = MySQLQuery.getAsInteger(req.getString("appId"));
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                Logger.getLogger(sendPushByEmpApp.class.getName()).log(Level.SEVERE, null, ex);
                out.write("error");
            } finally {
