...
@WebServlet(name = "StartOrderDelivery", urlPatterns = {"/vicky/StartOrderDelivery"})
public class StartOrderDelivery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        statusChecker.scheduleCheck(orderId);
    }
