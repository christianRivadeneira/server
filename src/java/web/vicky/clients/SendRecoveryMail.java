...
public class SendRecoveryMail {
    ...
    public static void sendMail(ClieUsr usr, Connection con) throws Exception {
        ...
        SendMail.sendMail(con, usr.mail, "Recuperación de contraseña Mi Montagas", html, plain);
    }
}
