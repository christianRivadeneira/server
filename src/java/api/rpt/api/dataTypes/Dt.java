...
public class Dt extends DataType {

    private static final String STR_FORMAT = "dd/MM/yyyy hh:mm:ss a";
    ...
    public String getAsSQLString(Object content) {
        return MySQLQuery.dateTimeFormat.format((java.util.Date) content);
    }
    ...
    public MySQLCol getMySQLCol() {
        return new MySQLCol(MySQLCol.TYPE_DD_MM_YYYY_HH12_MM_SS_A, 100, "Valor");
    }
