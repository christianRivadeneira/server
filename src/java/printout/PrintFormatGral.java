...
public class PrintFormatGral extends PrintFormatsGenerator {
    ...
    public File generateReport() throws Exception {
        try {
            ...
            boolean newPage = false, newPg = false;
            ...
            if (type.showSign) {
                ...
                lastyline = (newPg ? ct.getYLine() : (lastyline < ct.getYLine() ? lastyline : ct.getYLine()));
                ct.setYLine(lastyline);
                if (lastyline > 120) {
                    ct.setSimpleColumn(570, 25, 25, lastyline - ((signDriv != null || signResp != null) ? 20 : 100));
                } else {
                    document.newPage();
                    ct.setSimpleColumn(570, 25, 25, 750 - ((signDriv != null || signResp != null) ? 20 : 100));
                }
